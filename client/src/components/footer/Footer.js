                ...
                <div className="container text-center text-md-start mt-5">
                    ...
                    <div className="row mt-3">
                        ...
                        <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <Link href="/category/may-chieu" className="">Máy chiếu</Link>
                            </p>
                            <p>
                        ...
                        <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                            ...
                            <p><i className="fas fa-home me-3 text-secondary" /> Lô 1 Cư xá Thanh Đa</p>
                            <p>
                                <i className="fas fa-envelope me-3 text-secondary" />
                                thienuyaudio@gmail.com
                            </p>
                            <p><i className="fas fa-phone me-3 text-secondary" /> 079 2826 567 </p>
